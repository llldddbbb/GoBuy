...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'item_cat_id',width:80">商品类目ID</th>
        	<th data-options="field:'item_cat_name',width:100">商品类目</th>
            <th data-options="field:'param_data',width:300,formatter:formatItemParamData">规格(只显示分组名称)</th>
